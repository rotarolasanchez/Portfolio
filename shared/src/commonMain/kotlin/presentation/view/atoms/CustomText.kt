...
fun TextM3(
    ...
    leadingiconResourceId: DrawableResource = Res.drawable.baseline_visibility_24,
...
fun EditextM3(
    ...
    limitNumericStatus: Boolean = false,
    limitNumericNumber: Double = 0.0,
    trailingiconResourceId: DrawableResource,
    leadingiconColor: Color,
    trailingiconColor: Color,
    textDownEditext: String = "",
    trailingIconStatus: Boolean = false,
    ...
    leadingIconOnClick: (String) -> Unit = { _ -> },
    visibilityIconResourceId: DrawableResource= Res.drawable.baseline_visibility_24
) {
    val keyboardController = LocalSoftwareKeyboardController.current
